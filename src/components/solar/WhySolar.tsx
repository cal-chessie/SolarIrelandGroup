...
const benefits = [
  ...
  },
  {
    ...
    description:
      'The SEAI Solar PV scheme pays up to €1,800 towards your installation in 2026. Available to owner-occupiers in the Republic of Ireland (26 counties) with homes built and occupied before 2021. There is no minimum BER to qualify. Our team handles the full grant application on your behalf - all included in the price.',
