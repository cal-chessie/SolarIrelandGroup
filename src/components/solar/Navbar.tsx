...
const SOCIAL_LINKS = [
  { href: 'https://www.facebook.com/solarlreland', label: 'Facebook', color: 'hover:text-[#1877F2] hover:border-[#1877F2]/30' },
            ...
            <div className="flex items-center justify-center gap-3 mt-4">
              {SOCIAL_LINKS.map((s) => (
                ...
                >
                  ...
                  {s.label === 'X' && (
                    <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231 5.451-6.231zm-1.161 17.52h1.833L7.084 4.126H5.117l11.966 15.644z"/></svg>
                  )}
                </a>
              ))}
            </div>
