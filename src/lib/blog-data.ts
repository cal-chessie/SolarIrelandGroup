...
export const articles: Article[] = [
...

  {
    ...
    content: [
      ...
      { type: 'heading', level: 2, text: 'The Clean Export Guarantee: Winter\'s Secret Advantage' },
      { type: 'paragraph', text: 'The introduction of the Clean Export Guarantee (CEG) and smart meters in Ireland has fundamentally changed the winter equation. Under the CEG you are paid for the electricity you export in summer, which helps offset the electricity you buy back in winter. Here is how it works:' },
