/**
 * About page skeleton loading state.
 * Matches the structure of about/page.tsx:
 * - Breadcrumb skeleton
 * - Large heading + subtext skeleton
 * - 2-column layout skeleton (Our Story — image + text)
 * - 3-column grid of 6 value prop card skeletons
 * - 4-column team member card skeletons
 *
