  ...
  return (
    <>
      ...
      <p className="text-gray-400 leading-relaxed mb-4">
        ...
        <span className="text-amber-400 font-medium">solarireland.com</span>. It applies to all visitors
        ...
        {[
          {
            ...
            purpose: 'Website analytics service that helps us understand how visitors interact with solarireland.com. Collects anonymised data about page views, sessions, devices, and navigation. We have configured GA4 with IP anonymisation and disabled advertising data sharing.',
  ...
  return (
    <>
      ...
      <p className="text-gray-400 leading-relaxed mb-4">
        ...
        version at{' '}
        <span className="text-amber-400 font-medium">solarireland.com/cookies</span>. If you have
