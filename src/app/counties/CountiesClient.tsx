...
const counties: CountyData[] = [
  { name: 'Dublin', provinces: ['Leinster'], domain: 'solardublin.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3560, population: '1.45M', tagline: 'From Sandymount to Swords - terraces to estates, we know every roof' },
  { name: 'Wicklow', provinces: ['Leinster'], domain: 'solarwicklow.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3520, population: '155K', tagline: 'The Garden County - stunning scenery and serious solar potential' },
  { name: 'Wexford', provinces: ['Leinster'], domain: 'solarwexford.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3600, population: '156K', tagline: 'Sunny southeast at its finest - Hook Head leads the way' },
  { name: 'Carlow', provinces: ['Leinster'], domain: 'solarcarlow.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3540, population: '61K', tagline: 'The Dolmen County - solid ground for solar investment' },
  { name: 'Kildare', provinces: ['Leinster'], domain: 'solarkildare.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3550, population: '251K', tagline: 'Punchestown to Naas - commuter belt going green' },
  { name: 'Meath', provinces: ['Leinster'], domain: 'solarmeath.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3560, population: '234K', tagline: 'The Royal County - heritage homes meet modern energy' },
  { name: 'Louth', provinces: ['Leinster'], domain: 'solarlouth.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3530, population: '139K', tagline: 'The Wee County with big solar ambitions' },
  { name: 'Longford', provinces: ['Leinster'], domain: 'solarlongford.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3400, population: '46K', tagline: 'Heart of the Midlands - where community spirit shines' },
  { name: 'Westmeath', provinces: ['Leinster'], domain: 'solarwestmeath.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3430, population: '96K', tagline: 'Lakeside living with rooftop power to match' },
  { name: 'Offaly', provinces: ['Leinster'], domain: 'solaroffaly.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3420, population: '83K', tagline: 'From the Slieve Bloom to Shannonbridge - powering the Midlands' },
  { name: 'Laois', provinces: ['Leinster'], domain: 'solarlaois.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3430, population: '85K', tagline: 'Quiet county, bright future - solar energy for every home' },
  { name: 'Kilkenny', provinces: ['Leinster'], domain: 'solarkilkenny.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3500, population: '104K', tagline: 'The Marble City and beyond - medieval charm, modern energy' },

  { name: 'Cork', provinces: ['Munster'], domain: 'solarcork.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3580, population: '555K', tagline: 'The Rebel County runs on sunshine' },
  ...
  { name: 'Leitrim', provinces: ['Connacht'], domain: 'solarleitrim.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3350, population: '35K', tagline: 'The lovely county - small in size, big on green energy' },

  { name: 'Donegal', provinces: ['Ulster'], domain: 'solardonegal.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3410, population: '167K', tagline: 'From Malin Head to Donegal Town - the north-west shines bright' },
  { name: 'Cavan', provinces: ['Ulster'], domain: 'solarcavan.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3410, population: '81K', tagline: 'Lakeland County - drumlins and solar panels, a perfect match' },
  { name: 'Monaghan', provinces: ['Ulster'], domain: 'solarmonaghan.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3400, population: '68K', tagline: 'The Farney County - border spirit, boundless energy' },
  { name: 'Antrim', provinces: ['Ulster'], domain: 'solarantrim.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3450, population: '649K', tagline: 'Giant\'s Causeway coast and city rooftops - solar for all' },
  { name: 'Armagh', provinces: ['Ulster'], domain: 'solararmagh.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3420, population: '206K', tagline: 'The Orchard County - growing green energy from the ground up' },
  { name: 'Down', provinces: ['Ulster'], domain: 'solardown.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3440, population: '552K', tagline: 'The Mountains of Mourne meet clean energy on every roof' },
  { name: 'Fermanagh', provinces: ['Ulster'], domain: 'solarfermanagh.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3380, population: '62K', tagline: 'Lake country living - where nature and solar go hand in hand' },
  { name: 'Derry', provinces: ['Ulster'], domain: 'solarderry.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3400, population: '252K', tagline: 'The Maiden City - historic walls, forward-thinking energy' },
  { name: 'Tyrone', provinces: ['Ulster'], domain: 'solartyrone.ie', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3390, population: '193K', tagline: 'From the Sperrins to Strabane - solar across the county' },
];
