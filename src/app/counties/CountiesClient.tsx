...
const counties: CountyData[] = [
  { name: 'Dublin', provinces: ['Leinster'], domain: 'solardublin.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3560, population: '1.45M', tagline: 'From Sandymount to Swords - terraces to estates, we know every roof' },
  { name: 'Wicklow', provinces: ['Leinster'], domain: 'solarwicklow.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3520, population: '155K', tagline: 'The Garden County - stunning scenery and serious solar potential' },
  { name: 'Wexford', provinces: ['Leinster'], domain: 'solarwexford.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3600, population: '156K', tagline: 'Sunny southeast at its finest - Hook Head leads the way' },
  { name: 'Carlow', provinces: ['Leinster'], domain: 'solarcarlow.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3540, population: '61K', tagline: 'The Dolmen County - solid ground for solar investment' },
  { name: 'Kildare', provinces: ['Leinster'], domain: 'solarkildare.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3550, population: '251K', tagline: 'Punchestown to Naas - commuter belt going green' },
  { name: 'Meath', provinces: ['Leinster'], domain: 'solarmeath.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3560, population: '234K', tagline: 'The Royal County - heritage homes meet modern energy' },
  { name: 'Louth', provinces: ['Leinster'], domain: 'solarlouth.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3530, population: '139K', tagline: 'The Wee County with big solar ambitions' },
  { name: 'Longford', provinces: ['Leinster'], domain: 'solarlongford.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3400, population: '46K', tagline: 'Heart of the Midlands - where community spirit shines' },
  { name: 'Westmeath', provinces: ['Leinster'], domain: 'solarwestmeath.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3430, population: '96K', tagline: 'Lakeside living with rooftop power to match' },
  { name: 'Offaly', provinces: ['Leinster'], domain: 'solaroffaly.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3420, population: '83K', tagline: 'From the Slieve Bloom to Shannonbridge - powering the Midlands' },
  { name: 'Laois', provinces: ['Leinster'], domain: 'solarlaois.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3430, population: '85K', tagline: 'Quiet county, bright future - solar energy for every home' },
  { name: 'Kilkenny', provinces: ['Leinster'], domain: 'solarkilkenny.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3500, population: '104K', tagline: 'The Marble City and beyond - medieval charm, modern energy' },

  { name: 'Cork', provinces: ['Munster'], domain: 'solarcork.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3580, population: '555K', tagline: 'The Rebel County runs on sunshine' },
  { name: 'Kerry', provinces: ['Munster'], domain: 'solarkerry.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3540, population: '156K', tagline: 'From the Kingdom - wild Atlantic coast, serious solar savings' },
  { name: 'Limerick', provinces: ['Munster'], domain: 'solarlimerick.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3500, population: '205K', tagline: 'Treaty City homes switching on to solar' },
  { name: 'Clare', provinces: ['Munster'], domain: 'solarclare.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3470, population: '131K', tagline: 'The Banner County - from the Burren to your rooftop' },
  { name: 'Tipperary', provinces: ['Munster'], domain: 'solartipperary.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3480, population: '165K', tagline: 'Premier County homes leading the solar charge' },
  { name: 'Waterford', provinces: ['Munster'], domain: 'solarwaterford.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3550, population: '127K', tagline: 'The Déise - crystal city with a green energy vision' },

  { name: 'Galway', provinces: ['Connacht'], domain: 'solargalway.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3450, population: '279K', tagline: 'City of the Tribes - urban and county, we cover it all' },
  { name: 'Mayo', provinces: ['Connacht'], domain: 'solarmayo.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3400, population: '137K', tagline: 'Wild Mayo - big skies, open roofs, endless potential' },
  { name: 'Roscommon', provinces: ['Connacht'], domain: 'solarroscommon.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3380, population: '72K', tagline: 'Heart of the west - where every watt counts' },
  { name: 'Sligo', provinces: ['Connacht'], domain: 'solarsligo.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3390, population: '70K', tagline: 'Yeats Country catching rays on every rooftop' },
  { name: 'Leitrim', provinces: ['Connacht'], domain: 'solarleitrim.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3350, population: '35K', tagline: 'The lovely county - small in size, big on green energy' },

  { name: 'Donegal', provinces: ['Ulster'], domain: 'solardonegal.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3410, population: '167K', tagline: 'From Malin Head to Donegal Town - the north-west shines bright' },
  { name: 'Cavan', provinces: ['Ulster'], domain: 'solarcavan.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3410, population: '81K', tagline: 'Lakeland County - drumlins and solar panels, a perfect match' },
  { name: 'Monaghan', provinces: ['Ulster'], domain: 'solarmonaghan.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3400, population: '68K', tagline: 'The Farney County - border spirit, boundless energy' },
  { name: 'Antrim', provinces: ['Ulster'], domain: 'solarantrim.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3450, population: '649K', tagline: 'Giant\'s Causeway coast and city rooftops - solar for all' },
  { name: 'Armagh', provinces: ['Ulster'], domain: 'solararmagh.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3420, population: '206K', tagline: 'The Orchard County - growing green energy from the ground up' },
  { name: 'Down', provinces: ['Ulster'], domain: 'solardown.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3440, population: '552K', tagline: 'The Mountains of Mourne meet clean energy on every roof' },
  { name: 'Fermanagh', provinces: ['Ulster'], domain: 'solarfermanagh.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3380, population: '62K', tagline: 'Lake country living - where nature and solar go hand in hand' },
  { name: 'Derry', provinces: ['Ulster'], domain: 'solarderry.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3400, population: '252K', tagline: 'The Maiden City - historic walls, forward-thinking energy' },
  { name: 'Tyrone', provinces: ['Ulster'], domain: 'solartyrone.com', status: 'active', costMin: 8200, costMax: 12400, generationKwh: 3390, population: '193K', tagline: 'From the Sperrins to Strabane - solar across the county' },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes. We install in all 32 counties. Pick your county above for its local generation figure, typical system cost and what the SEAI grant covers there. Surveys are free everywhere we operate, and the €1,800 grant applies in the 26 Republic of Ireland counties.',
  },
  {
    question: 'Can I get a free solar survey in my area?',
    answer: 'Absolutely. Solar Ireland offers free, no-obligation roof surveys across all 32 counties. A local surveyor will visit your home (or conduct a detailed remote assessment) to evaluate your roof orientation, pitch, shading from nearby trees or buildings, and your current electricity usage. You\'ll receive a personalised proposal with an exact system size, generation estimate, cost breakdown, projected savings, and payback period. The survey costs nothing and commits you to nothing. If your roof will not carry a system worth fitting, we will tell you that instead of quoting you anyway.',
  },
  {
        ...
        <header className="relative overflow-hidden">
          ...
          <div className="max-w-6xl xl:max-w-[74rem] 2xl:max-w-[78rem] mx-auto px-5 sm:px-8 pt-12 sm:pt-20 pb-10 sm:pb-14 relative">
            ...
            <p className="text-gray-400 text-base sm:text-lg max-w-3xl leading-relaxed mb-4">
              We cover all 32 counties. Dublin terrace, Cork semi-d, Donegal cottage: pick your
              county below for local generation figures, what a system costs there, and how the
              SEAI grant applies to your house.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-400">Free survey <span className="text-white font-semibold">nationwide</span></span>
              </div>
            </div>
          </div>
        </header>
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  aria-label="Search counties" placeholder="Search counties..."
                  className="w-full pl-11 pr-10 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-base text-white placeholder-gray-600 focus:outline-none focus:border-amber-400/30 focus:ring-1 focus:ring-amber-400/10 transition-all"
                />
                {searchQuery && (
                  <button
              ...
              <div className="mt-16 sm:mt-20 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-amber-400/10 via-amber-500/[0.05] to-transparent border border-amber-400/10 p-8 sm:p-12 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-400 text-base max-w-lg mx-auto mb-6 leading-relaxed">
                    ...
                    roof properly and handle the SEAI grant paperwork. The figures you get
                    are the ones we stand over.
                  </p>
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                    <a
                      href="/solar-calculator"
                      className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full bg-amber-400 text-black font-bold text-sm shadow-lg shadow-yellow-400/20 hover:shadow-yellow-400/30 hover:bg-yellow-300 transition-all active:scale-[0.98]"
                    >
