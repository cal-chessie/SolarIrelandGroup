    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <main className="pt-16">
        ...
        <section className="border-y border-white/[0.04] bg-white/[0.01]">
          <div className="max-w-6xl xl:max-w-7xl 2xl:max-w-[88rem] mx-auto px-5 sm:px-8 py-12 sm:py-16">
        ...
        <div className="sticky top-16 z-20 bg-[#0a0a0a]/95 border-b border-white/[0.04] backdrop-blur-sm">
          <div className="max-w-6xl xl:max-w-7xl 2xl:max-w-[88rem] mx-auto px-5 sm:px-8 py-4">
            {/* Search bar */}
            <div className="flex items-center gap-3">
        ...
        <div className="max-w-6xl xl:max-w-7xl 2xl:max-w-[88rem] mx-auto px-5 sm:px-8 py-10 sm:py-14">
